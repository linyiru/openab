...
**Alias syntax:** Use `@name` to reference a configured alias (see [Workspaces](/openab/workspaces.md)).
...
- [Workspaces](/openab/workspaces.md) — configuring workspace aliases
- [Output Directives](/openab/output-directives.md) — agent → platform directives
- [ADR: Control Directives](/openab/adr/control-directives.md) — design rationale
