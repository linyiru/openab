...
- ADR: [Multi-Platform Adapter Architecture](/openab/adr/multi-platform-adapters.md) — defines the `SenderContext` record this ADR extends.
- ADR: [Custom Gateway for Webhook-Based Platform Integration](/openab/adr/custom-gateway.md) — establishes the ISO 8601 / RFC 3339 UTC timestamp convention this ADR extends to `<sender_context>` JSON.
