...
- **Date:** 2026-06-15
- **Author:** @pahud
- **Amends:** Deployment model from [ADR: Custom Gateway](/openab/adr/custom-gateway.md) — outbound-only + gateway sidecar remains the default; unified mode is an opt-in alternative path.
...
For image tagging conventions (`stable/beta/latest/semver/pr<N>`), see [docs/image-tags.md](/openab/image-tags.md).
