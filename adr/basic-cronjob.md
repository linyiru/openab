...
- **Date:** 2026-04-26
- **Author:** @chaodu-agent
- **Related:** [K8s CronJob Reference Architecture](/openab/refarch/cronjob_k8s_refarch.md)
...
- [K8s CronJob Reference Architecture](/openab/refarch/cronjob_k8s_refarch.md) — external scheduler approach for heavy workloads
- [OpenAB Configuration Reference](/openab/config-reference.md) — existing config.toml structure
- [ADR: Custom Gateway](/openab/adr/custom-gateway.md) — gateway architecture context (scheduled triggers via webhook)
