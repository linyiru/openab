...
|-------|-------|-------------|
| **Phase 1** | iMessage adapter in Custom Gateway: poll chat.db, send via AppleScript, WebSocket to OAB | Custom Gateway ([ADR](/openab/adr/custom-gateway.md)) |
