...
- **Date:** 2026-04-22
- **Author:** @chaodu-agent
- **Supersedes:** Sections of [ADR: LINE Adapter](/openab/adr/line-adapter.md) (v2 Target Architecture)
- **Superseded by:** [ADR: Separate Binaries with Opt-In Unified Build](/openab/adr/unified-binary.md)
...
> (see [ADR: Separate Binaries with Opt-In Unified Build](/openab/adr/unified-binary.md)).
...
5. **Webhook correctness**: all adapters must validate signatures against exact raw request body bytes, per the constraints defined in [ADR: LINE Adapter](/openab/adr/line-adapter.md) Compliance #1.
...
- [ADR: LINE Messaging API Adapter](/openab/adr/line-adapter.md) — v1 LINE adapter design and v2 bridge concept that led to this ADR
