...
- **Date:** 2026-06-02
- **Author:** chaodu-agent
- **Related:** [Output Directives](/openab/output-directives.md)
...
- [Output Directives](/openab/output-directives.md) — existing `[[key:value]]` pattern for agent → platform
- [Steering Design Guide](/openab/steering-design-guide.md) — how workspace steering files are structured
