...
- [ADR: Custom Gateway](/openab/adr/custom-gateway.md) — Complementary architecture for inbound webhook handling
- [ADR: Multi-Platform Adapters](/openab/adr/multi-platform-adapters.md) — Platform-agnostic adapter layer
